...
class ControladorFavoritos{
    ...
    function insertar(){
        //Recibimos por GET el idMensaje y devolvemos un json con el número de mensajes
        ...
        $favorito->setIdUsuario($_SESSION['id']);
    ...
    function borrar(){
        //Recibimos por GET el idMensaje y devolvemos un json con el respuesta=ok si todo va bien
    }
}
